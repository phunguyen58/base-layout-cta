...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                items: [
                    { label: 'Yêu cầu đặt mua vật tư', icon: 'pi pi-shopping-cart', routerLink: ['/request-order'] },
                    { label: 'Kế hoạch mua vật tư', icon: 'pi pi-file-o', routerLink: ['/plan-order'] },
                    { label: 'Nhập kho', icon: 'pi pi-caret-right', routerLink: ['/uikit/floatlabel'] },
                    { label: 'Xuất kho', icon: 'pi pi-caret-left', routerLink: ['/uikit/invalidstate'] },
