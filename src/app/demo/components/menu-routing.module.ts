...
@NgModule({
    imports: [
        RouterModule.forChild([
            ...
            {
                path: 'stock-delivering',
                data: { breadcrumb: 'Invalid State' },
                loadChildren: () =>
                    import('./stock-delivering/stock-delivering.module').then(
                        (m) => m.StockDeliveringModule
                    ),
            },
            {
                path: 'list',
            ...
            {
                path: 'request-order',
                data: { breadcrumb: 'Request Order' },
                loadChildren: () =>
                    import('./request-order/request-order.module').then(
                        (m) => m.RequestOrderModule
                    ),
            },
            {
                path: 'create-request-order',
                data: { breadcrumb: 'Create Request Order' },
                loadChildren: () =>
                    import(
                        './create-request-order/create-request-order.module'
                    ).then((m) => m.CreateRequestOrderModule),
            },
            {
                path: 'plan-order',
                data: { breadcrumb: 'Plan Order' },
                loadChildren: () =>
                    import('./plan-order/plan-order.module').then(
                        (m) => m.PlanOrderModule
                    ),
            },
